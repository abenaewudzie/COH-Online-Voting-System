<nav class="navbar navbar-default navbar-static-top navbar-primary navbar-fixed" role="navigation" style="margin-bottom:6px;background-color:#0022ff;color:white;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" style = "color:white;">COH Voting System</a>
            ...
            <ul class="nav navbar-top-links navbar-right">
				...
				<?php 
					...
					$query = $conn->query("SELECT * from voters where voters_id ='{$_SESSION['voters_id']}'")or die (mysql_errno ());
